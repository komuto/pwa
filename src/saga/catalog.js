...
export const getCatalog = buildSaga(['id'], apis.getCatalog, actions.GET_CATALOG)
...
export const deleteCatalog = buildSaga(['id'], apis.deleteCatalog, actions.DELETE_CATALOG)
